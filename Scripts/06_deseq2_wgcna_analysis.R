...
write.csv(as.data.frame(res),
          "/mnt/e/plantgenomics/results/DESeq2_drought_results.csv")
sig_genes <- subset(res, padj < 0.05 & abs(log2FoldChange) > 1)
write.csv(as.data.frame(sig_genes),
          "/mnt/e/plantgenomics/results/DESeq2_significant_genes.csv")
...
write.csv(as.data.frame(top_terms),
          "/mnt/e/plantgenomics/results/GO_enrichment_results.csv")
...
write.csv(data.frame(gene=top_brown),
          "/mnt/e/plantgenomics/results/WGCNA_brown_hub_genes.csv")
write.csv(data.frame(gene=top_turquoise),
          "/mnt/e/plantgenomics/results/WGCNA_turquoise_hub_genes.csv")
write.csv(as.data.frame(moduleTraitCor),
          "/mnt/e/plantgenomics/results/WGCNA_module_trait_correlations.csv")
write.csv(data.frame(gene=names(moduleColors), module=moduleColors),
          "/mnt/e/plantgenomics/results/WGCNA_module_assignments.csv")

# Module-trait heatmap
png("/mnt/e/plantgenomics/results/WGCNA_module_trait_heatmap.png",
...
pheatmap(hub_matrix,
         ...
         filename="/mnt/e/plantgenomics/results/WGCNA_hub_gene_heatmap.png",
         width=10, height=8)
...
ggsave("/mnt/e/plantgenomics/results/hub_gene_network.png",
       plot=p, width=12, height=10, dpi=300, bg="white")

cat("====== Analysis Complete! ======\n")
cat("All results saved to: /mnt/e/plantgenomics/results/\n")
